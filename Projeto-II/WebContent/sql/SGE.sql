...
--
-- Host: localhost
-- Tempo de geração: 22/03/2016 às 20:28
...
CREATE TABLE `PESSOA` (
  ...
  `SIAPEFK` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `PLANO_TRABALHO` (
  ...
  `ID_PESSOA` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `USUARIO` (`ID`, `SIAPE`, `NOME`, `EMAIL`, `SENHA`, `ID_TIPO_USUARIO`) VALUES
(1, '1', 'administrador', 'administrador@ifpe.edu.br', 'c4ca4238a0b923820dcc509a6f75849b', 1),
(2, '2', 'professor', 'professor@ifpe.edu.br', 'c81e728d9d4c2f636f067f89cc14862c', 2);
...
--
ALTER TABLE `PESSOA`
  ADD CONSTRAINT `PESSOA_ibfk_1` FOREIGN KEY (`SIAPEFK`) REFERENCES `USUARIO` (`SIAPE`);

--
-- Restrições para tabelas `PLANO_TRABALHO`
--
ALTER TABLE `PLANO_TRABALHO`
  ADD CONSTRAINT `PLANO_TRABALHO_ibfk_1` FOREIGN KEY (`ID_PESSOA`) REFERENCES `USUARIO` (`SIAPE`);
