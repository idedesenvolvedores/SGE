...
<html><head>
        ...
        <div id="wrapper">
            <!-- Navigation -->
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #359135; color: #FFFFFF">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html" style="color: #FFFFFF">IFPE  -  S.G.E V1.0</a>
                </div>
                <!-- Top Menu Items -->
                <ul class="nav navbar-right top-nav" style="background-color: #359135; color: #FFFFFF">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #359135; color: #FFFFFF"><i class="fa fa-lg fa-user"></i> usuário <b class="caret"></b></a>
                        <ul class="dropdown-menu" style="background-color: #359135; color: #FFFFFF">
                            <li>
                                <a href="#" style="background-color: #359135; color: #FFFFFF"><i class="fa fa-fw fa-gear fa-lg"></i> conta </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <div class="collapse navbar-collapse navbar-colapse">
                    <ul class="nav navbar-nav side-nav" style="background-color: #359135; color: #FFFFFF">
                        <li syle="a:hover{ color: #000000}">
                            <a href="RegistroDeEntrga" style="color: #FFFFFF"><i class="fa fa-folder fa-lg"></i> Registro de entrega</a>
                        </li>
                        <li>
                            <a href="index.html" style="color: #FFFFFF"><i class="fa fa-graduation-cap fa-lg"></i> Cadastro de professor </a>
                        </li>
                        <li>
